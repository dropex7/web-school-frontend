  ...
  return (
    <section className="section-tap">
      ...
      <section className="main-section">
        ...
        <p className="p-under-tap">Наши курсы построены по специальной
          методике и благодаря практическим заданиям
          на курсах, материал будет усваиваться
          гораздо лучше, чем на обычных курсах или
          с помощью книги</p>
        <div className="div-start-learing" id="learning-first">
          <h3 className="h3-tasks">Задания</h3>
          <p className="under-tasks">При выполнении которых вы будете прокачивать свои скиллы</p>
          <button className="btn-start-learning"><p className="text-btn-learning">Начать обучение</p></button>
        </div>
        <div className="div-start-learing" id="learning-second">
          <h3 className="h3-tasks">Удобная платформа</h3>
          <p className="under-tasks">Платформа имеет удобный интерфейс,
            отчего Ваше обучение пройдет
